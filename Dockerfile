...
RUN echo "welcome to appgoogle-v2" > appgoogle/index.html
RUN echo "welcome to appyahoo-v2" > appyahoo/index.html
RUN echo "welcome to appamazon-v2" > appamazon/index.html
